...
import static network.minter.mintercore.util.ByteUtil.byteArrayToInt;
import static network.minter.mintercore.util.ByteUtil.intToBytesNoLeadZeroes;
import static network.minter.mintercore.util.ByteUtil.isNullOrZeroArray;
import static network.minter.mintercore.util.ByteUtil.isSingleZero;
