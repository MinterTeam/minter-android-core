...
import static network.minter.ethereuman.util.ByteUtil.byteArrayToInt;
import static network.minter.ethereuman.util.ByteUtil.intToBytesNoLeadZeroes;
import static network.minter.ethereuman.util.ByteUtil.isNullOrZeroArray;
import static network.minter.ethereuman.util.ByteUtil.isSingleZero;
...
public class RLP {
    ...
    private static void fullTraverse(byte[] msgData, int level, int startPos,
        ...
        try {
            ...
            throw new RuntimeException(
                    "Invalid RLP (excessive mem allocation while parsing) (" + Hex.toHexString(msgData, startPos,
                                                                                               endPos - startPos) + ")",
                    e);
        }
    }
