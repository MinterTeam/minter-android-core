...
import static network.minter.ethereuman.helpers.Preconditions.checkArgument;
import static network.minter.ethereuman.helpers.Preconditions.checkNotNull;
import static network.minter.ethereuman.helpers.Preconditions.checkPositionIndexes;
...
public final class UnsignedBytes {
    ...
    static class LexicographicalComparatorHolder {
        ...
        enum UnsafeComparator implements Comparator<byte[]> {
            ...
            static final UnsafeAndroid theUnsafe = getUnsafe();
            ...
            /**
             * Returns a UnsafeAndroid. Suitable for use in a 3rd party package. Replace with a simple
             * call to Unsafe.getUnsafe when integrating into a jdk.
             *
             * @return a UnsafeAndroid
             */
            private static UnsafeAndroid getUnsafe() {
                try {
                ...
                try {
                    return java.security.AccessController.doPrivileged(
                            new java.security.PrivilegedExceptionAction<UnsafeAndroid>() {
                                @Override
                                public UnsafeAndroid run() throws Exception {
                                    Class<UnsafeAndroid> k = UnsafeAndroid.class;
            ...
            public String toString() {
                return "UnsignedBytes.lexicographicalComparator() (UnsafeAndroid version)";
            }
        }
