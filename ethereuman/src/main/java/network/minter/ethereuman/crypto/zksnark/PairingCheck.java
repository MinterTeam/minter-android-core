 ...
 */
package network.minter.ethereuman.crypto.zksnark;

import java.math.BigInteger;
import java.util.ArrayList;
import java.util.List;

import static network.minter.ethereuman.crypto.zksnark.Params.B_Fp2;
import static network.minter.ethereuman.crypto.zksnark.Params.PAIRING_FINAL_EXPONENT_Z;
import static network.minter.ethereuman.crypto.zksnark.Params.TWIST;
