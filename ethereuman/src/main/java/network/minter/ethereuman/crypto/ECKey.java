 ...
 */
package network.minter.ethereuman.crypto;
/**
...
import network.minter.ethereuman.config.Constants;
import network.minter.ethereuman.crypto.jce.ECKeyAgreement;
...
public class ECKey implements Serializable {
    ...
    public static boolean verify(byte[] data, ECDSASignature signature, byte[] pub) {
        ...
        try {
            ...
            Timber.e(npe, "Caught NPE inside bouncy castle");
            return false;
        }
    }
