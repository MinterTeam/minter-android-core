...
public class AwesomeValidation {
    ...
    public void setClearErrorOnValidOnly(boolean clear) {
        mValidator.clearErrorOnValidOnly(clear);
    }

    public void addValidationListener(Validator.OnValidateListener listener) {
        mValidator.addListener(listener);
    }
