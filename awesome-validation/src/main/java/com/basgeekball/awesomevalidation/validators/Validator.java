...
public abstract class Validator {
    ...
    protected List<OnValidateListener> mValidateListeners = new ArrayList<>();
    protected boolean mHasFailed = false;
    protected boolean mClearOnValidOnly = false;

    public void addListener(OnValidateListener listener) {
        mValidateListeners.add(listener);
    }

    public void clearErrorOnValidOnly(boolean clear) {
        mClearOnValidOnly = clear;
    }

    public interface OnValidateListener {
        void onValidate(ValidationHolder validationHolder, boolean valid);
    }
    ...
    protected boolean checkFields(ValidationCallback callback) {
        ...
        for (ValidationHolder validationHolder : mValidationHolderList) {
            if (validationHolder.isVisible()) {
                ...
                for(OnValidateListener listener: mValidateListeners) {
                    listener.onValidate(validationHolder, result);
                }
            }
        }
        return result;
